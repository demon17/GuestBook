...
class Twig_Tests_Loader_FilesystemTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testPaths()
    {
        ...
        $this->assertEquals("path (final)\n", $loader->getSource('show_news.html'));
        $this->assertEquals("path (final)\n", $loader->getSource('@__main__/show_news.html'));
        $this->assertEquals("named path (final)\n", $loader->getSource('@named/show_news.html'));
    }
    ...
    public function testFindTemplateWithCache()
    {
        ...
        // prime the cache for show_news.html in the named namespace
        $namedSource = $loader->getSource('@named/show_news.html');
        $this->assertEquals("named path\n", $namedSource);

        // get show_news.html from the main namespace
